...
train_path = 'sample_dataset/Training'
test_path = 'sample_dataset/Test'
export_path = 'sample_dataset/tensorflow/mobilenet'
model_analytics_path = 'sample_dataset/tensorflow/mobilenet/mobilenet_info'
...
class_names = sorted(training_set.class_indices.items()
